...
class Constants
{
	...
	*/
    ...
    public static $UserNewsExpirePLanID="397";


    /*public static $UserNewsActivateTrailMessage="Dear user please activate trail just as shown in the above image.";  - NewsID :1
    public static $UserNewsExpireTrailMessage="Dear user your trail has been expired. Please purchase plan to take full advantage of our services.";  - NewsID :2
    public static $UserNewsExpirePLanMessage="Dear user please activate your trail or purchase our plan to see the trading calls."; - NewsID :41 */
